...
│   ├── bin/         # ~/bin shims: loadavg(1), tmux-copy(1), runtimes(1), packages(1)
...
`tmux-copy`, `runtimes`, `packages` (the direnv feature guide,
`docs/direnv-runtimes.md`, accompanies `runtimes`). Config files sourced by third-party programs (e.g.
